$(document).ready(function() {
    ...
    var select1 = $("#fut2-amount-wrapper");
    var slider1 = $("<div id='slider-fut2'></div>").insertAfter(select1).slider({
        min: 0,
        max: 1000000,
        value: 100,
        range: "min",
        change: function(event, ui) {
            var sliderValue = $("#slider-fut2").slider("option", "value");
            $('#fut2-amount').html(sliderValue);
            if (sliderValue == '100') {
                progressBar(20, $('#progressBar1'));
                $('#decrease-fut2').addClass('btn-disabled');
                $('.max-amount-fut2').fadeOut();
            } else if (sliderValue == '200') {
                progressBar(40, $('#progressBar1'));
                $('#decrease-fut2').removeClass('btn-disabled');
            } else if (sliderValue == '500') {
                progressBar(60, $('#progressBar1'));
                $('#increase-fut2').removeClass('btn-disabled');
                $('.max-amount-fut2').fadeOut();
            } else if (sliderValue == '1000') {
                progressBar(80, $('#progressBar1'));
                $('#increase-fut2').removeClass('btn-disabled');
                $('.max-amount-fut2').fadeOut();
    ...
    $('#fut2-select').change(function() {
        slider1.slider("value", $('#fut2-select').val());
    });
    ...
    function loading_step() {
        ...
        $('#resources-select-wrapper').fadeOut(500, function() {
            $('#processing-wrapper').fadeIn(500, function() {
                ...
                setTimeout(function() {
                    $console_message.html("Generating Packets for Rolls and Cash");
                    progressBarConsole(33, $('#progressBarConsole'));
                }, 11000);

                //-------------------------------1 Resurs Start-------------------------------//
                setTimeout(function() {
                    $console_message.html("Generating <span class='console-message-connected-item'>" + $console_message_fut1_msg + "</span> MonopolyGo Resources");
                ...
                setTimeout(function() {
                    $console_message.html("<span class='console-message-connected-item'>" + $console_message_fut1_msg + "</span> <span class='console-message-success'>App Mobile Resources Generated Successfully</span>");
                ...
                setTimeout(function() {
                    $console_message.html("Performing Device Version Verification");
                    progressBarConsole(83, $('#progressBarConsole'));
                }, 25500);
                setTimeout(function() {
                    $console_message.html("<span class='console-message-error'>Automatic Device Version Failed</span>");
                    progressBarConsole(87, $('#progressBarConsole'));
                }, 27500);
                setTimeout(function() {
                    $console_message.html("<span class='console-message-connected-item'>Manual Device Version Required</span>");
                    $(".console-message").addClass('pulse animated').one('webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend', function() {
                        $(this).removeClass('pulse animated');
                    });
                ...
                setTimeout(function() {
                    ...
                    $console_message.html("Waiting for Device Version Verification");
                    if ($(window).width() < 600) {
        ...
        if (ChatUserName == '') {
            ...
            if (!ChatReplied) {
                setTimeout(function() {
                    ...
                    setTimeout(function() {
                        ChatAddEntry(ChatUserNames[Random(0, ChatUserNames['length'] - 1)], '<span class="mention">@ ' + ChatUserName + ' &nbsp;</span>  is this your first time here? this is like the only legit fut R$ generator out there');
                        setTimeout(function() {
                            ChatAddEntry(ChatUserNames[Random(0, ChatUserNames['length'] - 1)], 'guys dont listen to ' + '<span class="mention">@ ' + ChatUserName + ' &nbsp;</span> ' + ' he just wants all R$ and points for himself haha');
